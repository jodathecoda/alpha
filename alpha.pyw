...
hu2x_img                    = ImageTk.PhotoImage(Image.open(cwd + "\\ranges\\alpha_defend60.png"))
pushfold_img                = ImageTk.PhotoImage(Image.open(cwd + "\\ranges\\pushfold.png"))
hu3x_img                    = ImageTk.PhotoImage(Image.open(cwd + "\\ranges\\alpha_open80.png"))
custom_img                  = ImageTk.PhotoImage(Image.open(cwd + "\\ranges\\ggop.png")) 
...
R5=Radiobutton(root, text="DEF", variable=bigblinds, value=11, command=call)
R5.grid(row=2, column=0, sticky=N+E)
R6=Radiobutton(root, text="ATT", variable=bigblinds, value=12, command=call)
R6.grid(row=3, column=0, sticky=N+E)
R7=Radiobutton(root, text="GGOP", variable=bigblinds, value=13, command=call)
